...
export const satelliteLookupTool = {
...
export const getSatellitePositionTool = {
...
export const predictPassesTool = {
    name: 'predict_passes',
    ...
    handler: async (args) => {
        return await orbitalService.predictPasses(args.catalogNumber, { latitude: args.latitude, longitude: args.longitude }, args.hoursAhead || 24);
    }
};
export const getOverheadSatellitesTool = {
...
export const getSatelliteInfoTool = {
...
export const countSatellitesTool = {
